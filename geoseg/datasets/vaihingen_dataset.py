...
def get_training_transform():
    train_transform = [
        ...
        albu.Normalize(mean=(0.485, 0.456, 0.406, 0.179),  ###0.120 vaihingen mean_nDSM 0.149 vaihingen std_nDSM
...
def train_aug(img, mask):
    crop_aug = Compose([RandomScale(scale_list=[1.0], mode='value'),  ###[0.5, 0.75, 1.0, 1.25, 1.5]
...
class VaihingenDataset(Dataset):
    def __init__(self, data_root='', mode='val',
                 img_dir='images_nDSM512', mask_dir='masks_nDSM512',
